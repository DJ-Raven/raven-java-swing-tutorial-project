...
public class TestFixedWidthStatus extends JFrame {

    public TestFixedWidthStatus() {
        ...
        //pass fixed width for the status column
        TableBadgeCellRenderer.apply(table, StaffStatus.class,120);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new TestFixedWidthStatus().setVisible(true));
    }
}
