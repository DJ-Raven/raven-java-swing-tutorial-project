...
/**
 *
 * The source code this class from modal-dialog project
 * sell: https://github.com/DJ-Raven/swing-modal-dialog/blob/main/modal-dialog/src/main/java/raven/modal/toast/icon/RollingIcon.java
 *
 * @author Raven
 */
